    ...
    <section className='Filters'>
      <Container>
        <div className='Filters-cards'>
          ...
          <div className='Filters-card'>
            <div className='Filters-img'>
              <img src={Trip2} style={{height:"100%",width:"100%"}} />
            </div>
          </div>
          <div className='Filters-card'>
            <div className='Filters-img'>
              <img src={Trip3} style={{height:"100%",width:"100%"}} />
            </div>
          </div>
          <div className='Filters-card'>
            <div className='Filters-img'>
              <img src={Trip4} style={{height:"100%",width:"100%"}} />
            </div>
          </div>
          <div className='Filters-card'>
            <div className='Filters-img'>
              <img src={Trip5} style={{height:"100%",width:"100%"}} />
            </div>
          </div>
          <div className='Filters-card'>
            <div className='Filters-img'>
              <img src={Trip6} style={{height:"100%",width:"100%"}} />
            </div>
          </div>
        </div>
      </Container>
